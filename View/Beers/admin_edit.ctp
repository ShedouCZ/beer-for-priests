<div class="beers form">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
							...
							<li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;' . __('Delete'), array('action'=>'delete', $this->Form->value('Beer.id')), array('escape'=>false), __('Are you sure you want to delete # %s?', $this->Form->value('Beer.id'))); ?></li>
							<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;' . __('List Beers'), array('action'=>'index'), array('escape'=>false)); ?></li>
					</ul>
								<h1><?php echo __('Admin Edit Beer'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Beer', array('role'=>'form', 'class'=>'form-horizontal')); ?>
